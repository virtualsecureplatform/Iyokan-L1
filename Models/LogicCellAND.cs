...
{
    public class LogicCellAND : LogicCell
    {
        public class Input
        {
            [JsonIgnore]
        ...
        public LogicCellAND(YosysCell yosysCell)
        {
        ...
        { 
            return $"[Cell] id:{this.id} type:{this.type} inputA:{this.input.A} inputB:{this.input.B} outputY:{this.output.Y.ToString<int>()}";
        }
