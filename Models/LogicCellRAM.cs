...
namespace Iyokan_L1.Models
{
    public class LogicCellRAM : LogicCell
    {
        ...
        public LogicCellRAM(YosysCell yosysCell, int ramAddress, int ramBit)
        {
        ...
        {
            return
                $"[Cell] id:{this.id} type:{this.type} addr:{this.ramAddress} bit:{this.ramBit} inputD:{this.input.D} outputQ:{this.output.Q.ToString<int>()}";
        }
